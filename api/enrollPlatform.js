...
async function main() {
    try {
        ...
        const ca = new FabricCAServices("https://localhost:8054", { trustedRoots: caTLSCACerts, verify: false }, caInfo.caName);
        ...
        const identity = await wallet.get('adminPlatform');
        if (identity) {
        ...
        await wallet.put('adminPlatform', x509Identity);
