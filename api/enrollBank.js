...
async function main() {
    try {
        ...
        const ca = new FabricCAServices("https://localhost:7054", { trustedRoots: caTLSCACerts, verify: false }, caInfo.caName);
        ...
        const identity = await wallet.get('adminBank');
        if (identity) {
        ...
        await wallet.put('adminBank', x509Identity);
